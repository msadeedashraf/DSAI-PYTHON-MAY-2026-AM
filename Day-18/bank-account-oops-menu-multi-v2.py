...
def list_allaccounts(accounts):
    ...
    for account_number, account in accounts.items():
        print(f"{account_number} | {account.account_holder_name} | {account.balance} | Active: {account.is_active}")
    print(f"\n========================================")
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            # account = find_account(accounts) to filter one account from a list of accounts
            # if account is None:
