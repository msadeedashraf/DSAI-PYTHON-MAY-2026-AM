# With file dynamic file name and multi file read
...
FOLDER_PATH = r"D:\CBC\DSAI-Jan-2026-AM\05-Python\DSAI-PYTHON-MAY-2026-AM\Day-16\statements"

def create_file_name():
    current_time = datetime.now()
    return current_time.strftime("%d_%b_%Y_%H_%M_%S").upper()+".txt"
...
def read_statement():
    ...
    statement_files.sort(reverse=True)

    print("\n========== AVAILABLE STATEMENTS ==========")

    for index, file_name in enumerate(statement_files, start=1):
        print(f"{index}. {file_name}")

    print("==========================================")

    choice = input("\nEnter statement number to read: ")
    ...
    if choice < 1 or choice > len(statement_files):
        print("\nInvalid statement number.")
        return

    selected_file = statement_files[choice - 1]
